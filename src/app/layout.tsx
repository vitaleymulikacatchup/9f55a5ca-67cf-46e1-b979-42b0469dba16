...
export const metadata: Metadata = {
  title: "Brew & Bean - Artisan Coffee Shop | Premium Craft Coffee",
  description: "Experience exceptional coffee at Brew & Bean. Premium beans, expert brewing, and welcoming atmosphere. Visit our coffee shop for the perfect cup.",
  keywords: "coffee shop, artisan coffee, premium coffee beans, specialty coffee, craft coffee, local coffee shop",
  ...
  openGraph: {
    ...
    description: "Experience exceptional coffee crafted with passion. Premium beans, expert brewing, welcoming atmosphere.",
    siteName: "Brew & Bean",
    images: [
      {
  ...
  twitter: {
    ...
    title: "Brew & Bean - Artisan Coffee Shop",
    description: "Experience exceptional coffee crafted with passion. Premium beans, expert brewing, welcoming atmosphere.",
    images: ["https://images.pexels.com/photos/2067431/pexels-photo-2067431.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"]
  },
  robots: {
    index: true,
    follow: true
